...
class EcommerceLocators:
    ...
    CATEGORY_MENU = (By.CSS_SELECTOR, "#side-menu")
    CATEGORY_ITEMS = (By.CSS_SELECTOR, "#side-menu .nav-item")
    SUBCATEGORY_ITEMS = (By.CSS_SELECTOR, ".nav-item .nav.nav-list li a")
    SUBCATEGORY_LINKS = (By.CSS_SELECTOR, ".sidebar-nav .nav-list li a")
    ...
    PAGINATION_ITEMS = (By.CSS_SELECTOR, ".pagination li")
    NEXT_PAGE = (By.CSS_SELECTOR, ".pagination .next a")
    
    # Product detail page
    ADD_TO_CART_BUTTON = (By.CSS_SELECTOR, ".btn-success")
    PRODUCT_GALLERY = (By.CSS_SELECTOR, ".gallery")
    PRODUCT_PROPERTIES = (By.CSS_SELECTOR, ".properties")

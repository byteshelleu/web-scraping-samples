    ...
    def validate_data(self, data):
        ...
        for item in data:
            ...
            if not item.get('title'):
                self.logger.warning("Product missing title")
                return False
        
        self.logger.info(f"Data validation successful for {len(data)} items")
        return True
    ...
    def process_product_data(self, products):
        ...
        for product in products:
            ...
            if 'price' in processed_product:
                processed_product['price_value'] = self.extract_price_value(processed_product['price'])
